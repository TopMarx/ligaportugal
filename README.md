# Liga Portugal Fantasy

Liga Portugal Fantasy fantasy game data, fetched directly from the official fantasy API at
`https://fantasy.ligaportugal.pt/api/`.
...
| File | Description |
|---|---|
| `data/{season}/ligaportugal-bootstrap_{season}.json` | Players, teams, gameweeks, game settings |
| `data/{season}/ligaportugal-fixtures_{season}.json` | All season fixtures with scores |
...
| `data/{season}/ligaportugal-dream-team_{season}.json` | Season dream team (updated each GW) |
| `data/{season}/ligaportugal-set-piece-notes_{season}.json` | Set piece taker notes (if the league API provides them) |
| `data/{season}/ligaportugal-regions_{season}.json` | Region/nationality reference (if the league API provides it) |
...
| File | Description |
|---|---|
| `latest/ligaportugal-bootstrap.json` | Current bootstrap |
| `latest/ligaportugal-fixtures.json` | Current fixtures |
...
# Latest bootstrap
url = "https://raw.githubusercontent.com/TopMarx/ligaportugal/main/latest/ligaportugal-bootstrap.json"
...
```
https://raw.githubusercontent.com/TopMarx/ligaportugal/main/data/{season}/ligaportugal-bootstrap_{season}.json
https://raw.githubusercontent.com/TopMarx/ligaportugal/main/latest/ligaportugal-bootstrap.json
```

### Clone the repo

```
git clone https://github.com/TopMarx/ligaportugal.git
```
